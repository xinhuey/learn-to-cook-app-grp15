...
export const getRecipes = async (c) => {
  try {
    ...
    const ingredients = c.req.query('ingredients') // Preferred ingredients to include
    const excludeIngredients = c.req.query('exclude_ingredients') // Allergies to exclude
